...
} from "/build/_shared/chunk-7ZOU4YDU.js";
...
// app/entry.client.tsx
init_redux();
var import_redux_devtools_extension = __toESM(require_redux_devtools_extension());

// app/reducers/index.ts
init_redux();

// app/reducers/userReducer.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/reducers/userReducer.ts"
  );
  import.meta.hot.lastModified = "1695569920846.197";
}
function userReducer(state = api.get("user") ? JSON.parse(api.get("user")) : null, action) {
  switch (action.type) {
    case "LOGIN":
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695567532545.6436";
}
...
(0, import_react2.startTransition)(() => {
  (0, import_client.hydrateRoot)(
    document,
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react2.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Provider_default, { store, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_wagmi2.WagmiConfig, { config, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(PriceContextProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      ConnectKitProvider,
      {
        onConnect: async (kit) => {
          console.log(kit);
