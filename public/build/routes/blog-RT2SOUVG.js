...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695297940768.0906";
}
var meta = () => {
  return [{
    title: "Blog \u2014 Maxiruby"
...
function Blog() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
            className: "flex flex-1 flex-row flex-wrap items-center justify-between gap-5", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-3xl font-medium font-heading", children: "Blog" }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", {
            className: "w-full grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6", children: projects && projects.map((blog) => {
...
function BlogCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
    to: `/blog/${blog._id}`, className: "flex flex-col gap-y-5 hover:opacity-80 transition-opacity duration-150", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
      className: "relative flex flex-col rounded-xl overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        className: "relative flex flex-1 w-full h-full pb-[52%] overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
          className: "absolute inset-0 w-full h-full overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image_default, { src: blog.image, alt: "Blog", width: "100%", height: "100%", objectFit: "cover" }, void 0, false, {
            fileName: "app/routes/blog.tsx",
            lineNumber: 78,
            columnNumber: 13
          }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      className: "flex flex-col gap-y-1", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", {
        className: "line-clamp-3 font-medium text-sm text-muted-foreground", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
...
//# sourceMappingURL=/build/routes/blog-RT2SOUVG.js.map
