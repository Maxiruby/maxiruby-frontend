...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695297940768.3213";
}
var meta = ({
  data
}) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    className: "flex flex-1 flex-col h-full min-h-[75vh]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Section, {
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, {
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
          className: "flex flex-1 flex-col gap-y-8", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
            className: "flex flex-col gap-y-3", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
              className: "relative block max-h-[640px] mx-auto w-full rounded-xl overflow-hidden mb-5", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image_default, { src: projects.image, alt: projects.title, width: "100%", height: "100%", objectFit: "contain" }, void 0, false, {
                fileName: "app/routes/blog_.$id.tsx",
                lineNumber: 74,
                columnNumber: 17
              }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", {
              className: "text-lg font-semibold", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
...
//# sourceMappingURL=/build/routes/blog_.$id-3LSSYGNL.js.map
