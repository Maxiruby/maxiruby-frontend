...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1693768849000";
}
var meta = () => {
  return [{
...
function Signup() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = fetch("http://maxiruby.com/api/users/auth/register", requestOptions);
...
_s(Signup, "Nz1y/m0OqJJyxvIj9ObAMaGI4bc=", false, function() {
...
//# sourceMappingURL=/build/routes/signup._index-FHOO62LW.js.map
