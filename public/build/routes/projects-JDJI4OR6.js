...
import "/build/_shared/chunk-VUM2LAN5.js";
import {
  Container,
  Section
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1694030972817.8662";
}
var meta = () => {
  return [{
...
function Projects() {
  ...
  (0, import_react.useEffect)(() => {
    const getAllProject = async () => {
      ...
      fetch("http://maxiruby.com/api/landing/all", requestOptions).then((response) => response.json()).then((result) => setProjects(result.result)).catch((error) => console.log("error", error));
    };
    getAllProject();
  }, []);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-1 flex-col h-full min-h-[75vh]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Section, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Container, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-1 flex-col gap-y-10", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", { className: "flex flex-1 flex-wrap items-start justify-start gap-6", children: filteredProjects.length > 0 ? filteredProjects.map((p, i) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Project, { project: p }, i, false, {
      fileName: "app/routes/projects.tsx",
      lineNumber: 79,
      columnNumber: 77
...
//# sourceMappingURL=/build/routes/projects-JDJI4OR6.js.map
