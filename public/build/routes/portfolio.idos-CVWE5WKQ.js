...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695297940769.7502";
}
var meta = () => {
  return [{
...
function PortfolioIDOsParticipated() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    className: "flex flex-1 flex-col w-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
      className: "flex flex-1 flex-col w-full max-w-[700px] mx-auto bg-card rounded-xl py-8 px-6 gap-y-8", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("header", {
        className: "flex flex-col justify-center items-center text-center gap-y-2 pb-5 border-b border-solid border-border", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        className: "flex flex-col gap-y-5", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", {
          className: "flex flex-col gap-y-6", children: projects.projects ? projects.projects.map((p, i) => /* @__PURE__ */(0, import_jsx_dev_runtime.jsxDEV)("li", {
            className: "flex flex-1 items-center justify-between gap-x-5", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
              className: "flex items-center gap-x-3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
                className: "relative flex w-12 h-12 rounded-full bg-secondary overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { src: p.project_image, alt: p.project_image, className: "w-full h-full object-cover" }, void 0, false, {
                  fileName: "app/routes/portfolio.idos.tsx",
                  lineNumber: 73,
                  columnNumber: 23
                }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, {
              to: "/projects/" + p._id, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, { type: "button", title: "View", variant: "secondary", children: "View More" }, void 0, false, {
                fileName: "app/routes/portfolio.idos.tsx",
                lineNumber: 80,
                columnNumber: 21
              }, this)
...
//# sourceMappingURL=/build/routes/portfolio.idos-CVWE5WKQ.js.map
