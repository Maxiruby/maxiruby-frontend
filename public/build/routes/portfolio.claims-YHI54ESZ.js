...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1694273595928.7617";
}
var meta = () => {
  return [{
...
function PortfolioClaims() {
  ...
  (0, import_react2.useEffect)(() => {
    const getAllProject = async () => {
      ...
      fetch("http://maxiruby.com/api/users/auth/getproject", requestOptions).then((response) => response.text()).then((result) => setProjects(JSON.parse(result).result)).catch((error) => console.log("error", error));
    };
    getAllProject();
  }, []);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-1 flex-col w-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-1 flex-col w-full max-w-[1100px] mx-auto bg-card rounded-xl py-8 px-6 gap-y-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { className: "flex flex-col gap-y-6", children: projects.projects && projects?.projects?.filter((project) => project.status === "claim").map((project, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", { className: "flex flex-1 flex-wrap items-center justify-between gap-5", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/projects/1", className: "mx-auto sm:mx-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, { type: "button", title: "Claim", variant: "primary", children: "Claim" }, void 0, false, {
      fileName: "app/routes/portfolio.claims.tsx",
      lineNumber: 88,
      columnNumber: 21
    }, this) }, void 0, false, {
...
function ClaimCountdown({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex flex-col justify-center items-center gap-y-3", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("strong", { className: "text-sm text-muted-foreground font-semibold", children: [
...
//# sourceMappingURL=/build/routes/portfolio.claims-YHI54ESZ.js.map
