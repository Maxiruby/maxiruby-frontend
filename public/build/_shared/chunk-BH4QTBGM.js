...
var init_index_modern = __esm({
  "node_modules/proxy-compare/dist/index.modern.js"() {
    ...
    l = (e2) => e2 && (c.has(e2) ? c.get(e2) : s(e2) === Object.prototype || s(e2) === Array.prototype);
    y = (e2) => l(e2) && e2[t] || null;
    h = (e2, t2 = true) => {
      c.set(e2, t2);
    };
...
var o, T, a, _, r, R, c2, p, W, y2, V, D, H, B, M, K, L, E, O, m, z, j, J, q, k, F, N, d, te, I, se, G, $, Q, X, S, Y, C, ne, g, oe;
var init_dist = __esm({
  "node_modules/@walletconnect/modal-core/dist/index.js"() {
    init_vanilla();
    o = proxy({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 });
    T = { state: o, subscribe(e2) {
    ...
    r = proxy({ enabled: _, userSessionId: "", events: [], connectedWalletId: void 0 });
    R = { state: r, subscribe(e2) {
    ...
    c2 = proxy({ chains: void 0, walletConnectUri: void 0, isAuth: false, isCustomDesktop: false, isCustomMobile: false, isDataLoaded: false, isUiLoaded: false });
    p = { state: c2, subscribe(e2) {
    ...
    W = proxy({ projectId: "", mobileWallets: void 0, desktopWallets: void 0, walletImages: void 0, chains: void 0, enableAuthMode: false, enableExplorer: true, explorerExcludedWalletIds: void 0, explorerRecommendedWalletIds: void 0, termsOfServiceUrl: void 0, privacyPolicyUrl: void 0 });
    y2 = { state: W, subscribe(e2) {
    ...
    M = (e2, t2, s2) => t2 in e2 ? V(e2, t2, { enumerable: true, configurable: true, writable: true, value: s2 }) : e2[t2] = s2;
    K = (e2, t2) => {
      for (var s2 in t2 || (t2 = {}))
    ...
    k = (e2, t2, s2) => t2 in e2 ? z(e2, t2, { enumerable: true, configurable: true, writable: true, value: s2 }) : e2[t2] = s2;
    F = (e2, t2) => {
      for (var s2 in t2 || (t2 = {}))
    ...
    N = a.isMobile();
    d = proxy({ wallets: { listings: [], total: 0, page: 1 }, search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] });
    te = { state: d, async getRecomendedWallets() {
    ...
    S = (e2, t2, s2) => t2 in e2 ? G(e2, t2, { enumerable: true, configurable: true, writable: true, value: s2 }) : e2[t2] = s2;
    Y = (e2, t2) => {
      for (var s2 in t2 || (t2 = {}))
    ...
    C = proxy({ themeMode: Z() ? "dark" : "light" });
    ne = { state: C, subscribe(e2) {
      return subscribe(C, () => e2(C));
    }, setThemeConfig(e2) {
      const { themeMode: t2, themeVariables: s2 } = e2;
      t2 && (C.themeMode = t2), s2 && (C.themeVariables = Y({}, s2));
    } };
    g = proxy({ open: false, message: "", variant: "success" });
    oe = { state: g, subscribe(e2) {
...
//# sourceMappingURL=/build/_shared/chunk-BH4QTBGM.js.map
